      ...
      <div className="w-full max-w-2xl bg-[#131316] border border-[#27272e] rounded-2xl shadow-2xl shadow-black/50 max-h-[85vh] overflow-y-auto">
        ...
        <div className="sticky top-0 z-10 bg-[#131316] flex items-center justify-between px-8 py-5 border-b border-[#27272e]">
          <div className="flex items-center gap-3">
            ...
            />
            <h2 className="text-lg text-[#f5f5f7]">Détail de l'incident</h2>
          </div>
          <button
            onClick={onClose}
        ...
        <div className="px-8 py-6 space-y-6">
          ...
          {/* Title */}
          <h3 className="text-xl text-[#f5f5f7]">{incident.title}</h3>
          ...
          <div>
            ...
            <div className="grid grid-cols-2 gap-3">
              <div className="p-4 bg-[#1c1c21] rounded-xl">
                <p className="text-[10px] text-[#71717a] mb-1">Signalé par</p>
                <p className="text-sm text-[#f5f5f7]">{incident.reportedBy}</p>
              </div>
              <div className="p-4 bg-[#1c1c21] rounded-xl">
              ...
              {incident.resolvedAt && (
                <>
                  <div className="p-4 bg-[#1c1c21] rounded-xl">
                    <p className="text-[10px] text-[#71717a] mb-1">Résolu le</p>
                    <p className="text-sm text-[#f5f5f7]">
          ...
          {eq && (
            <div>
              ...
              <div className="flex items-center gap-4 p-4 bg-[#1c1c21] border border-[#27272e] rounded-xl">
                <div className="p-2.5 bg-[#27272e] rounded-lg">
                  <Wrench size={18} className="text-[#a1a1aa]" />
                </div>
                <div className="flex-1">
                  <p className="text-sm text-[#f5f5f7]">{eq.name}</p>
