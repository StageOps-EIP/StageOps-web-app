  ...
  return (
    ...
    >
      <div className="flex items-start justify-between gap-2 mb-2">
        <span className="text-sm text-content-primary line-clamp-2">
          {incident.title}
        </span>
        <span
      ...
      <p className="text-xs text-content-subtle line-clamp-2 mb-3">
      ...
      <div className="flex items-center justify-between">
        ...
        <span className="text-[10px] text-content-subtle ml-auto">
