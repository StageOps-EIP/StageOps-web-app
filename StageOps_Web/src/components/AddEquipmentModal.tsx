...
export function AddEquipmentModal({
  ...
  return (
    ...
    >
      <div className="w-full max-w-2xl bg-[#131316] border border-[#27272e] rounded-2xl shadow-2xl shadow-black/50 max-h-[85vh] overflow-y-auto">

        {/* Header */}
        <div className="sticky top-0 z-10 bg-[#131316] flex items-center justify-between px-8 py-5 border-b border-[#27272e]">
          <div className="flex items-center gap-3">
            ...
            />
            <div>
              <h2 className="text-lg font-semibold text-[#f5f5f7]">Ajouter un équipement</h2>
              <p className="text-xs text-[#71717a]">Nouvel équipement dans l'inventaire</p>
            </div>
          </div>
          <button
            onClick={onClose}
            className="p-2 rounded-xl hover:bg-[#27272e] text-[#71717a] hover:text-[#f5f5f7] transition-colors"
          >
            <X size={18} />
          </button>
        </div>
        ...
        <div className="px-8 py-6 space-y-6">
          ...
          {/* Nom */}
          <div>
            <p className="text-xs text-[#71717a] uppercase tracking-wider mb-3">Nom de l'équipement *</p>
            <input
              type="text"
              value={form.name}
              onChange={(e) => set('name', e.target.value)}
              placeholder="Ex : Console Son DiGiCo SD12"
              className={`w-full bg-[#1c1c21] border rounded-xl px-4 py-3 text-sm text-[#f5f5f7] placeholder-[#35353e] focus:outline-none focus:ring-2 focus:ring-cyan-400/50 transition-colors ${
                errors.name ? 'border-red-500/60' : 'border-[#27272e] focus:border-cyan-400/50'
              }`}
            />
            {errors.name && (
          ...
          {/* Catégorie */}
          <div>
            <p className="text-xs text-[#71717a] uppercase tracking-wider mb-3">Catégorie</p>
          ...
          {/* Statut */}
          <div>
            <p className="text-xs text-[#71717a] uppercase tracking-wider mb-3">Statut initial</p>
          ...
          {/* Emplacement & Zone */}
          <div>
            <p className="text-xs text-[#71717a] uppercase tracking-wider mb-3">Localisation</p>
            <div className="grid grid-cols-2 gap-3">
              <div className="p-4 bg-[#1c1c21] rounded-xl">
                <div className="flex items-center gap-1.5 mb-2">
                  <MapPin size={12} className="text-[#71717a]" />
                  <p className="text-[10px] text-[#71717a] uppercase tracking-wider">Emplacement *</p>
                </div>
                <input
                  type="text"
                  value={form.location}
                  ...
                  className={`w-full bg-transparent text-sm text-[#f5f5f7] placeholder-[#35353e] border-b focus:outline-none pb-0.5 transition-colors ${
                    errors.location ? 'border-red-500/60' : 'border-[#27272e] focus:border-cyan-400'
                  }`}
                />
                {errors.location && (
              ...
              <div className="p-4 bg-[#1c1c21] rounded-xl">
                <div className="flex items-center gap-1.5 mb-2">
                  <MapPin size={12} className="text-[#71717a]" />
                  <p className="text-[10px] text-[#71717a] uppercase tracking-wider">Zone</p>
                </div>
                <input
                  type="text"
                  value={form.zone}
          ...
          {/* Responsable */}
          <div>
            <p className="text-xs text-[#71717a] uppercase tracking-wider mb-3">Responsable</p>
            <div className="relative">
              <User size={15} className="absolute left-3.5 top-1/2 -translate-y-1/2 text-[#71717a] pointer-events-none" />
              <input
                type="text"
                value={form.responsiblePerson}
                onChange={(e) => set('responsiblePerson', e.target.value)}
                placeholder="Nom du responsable"
                className="w-full bg-[#1c1c21] border border-[#27272e] rounded-xl pl-9 pr-4 py-3 text-sm text-[#f5f5f7] placeholder-[#35353e] focus:outline-none focus:ring-2 focus:ring-cyan-400/50 focus:border-cyan-400/50 transition-colors"
              />
            </div>
          </div>
          ...
          {/* QR Code */}
          <div>
            <p className="text-xs text-[#71717a] uppercase tracking-wider mb-3">QR Code</p>
            <div className="relative">
              ...
              <input
                ...
                className="w-full bg-[#1c1c21] border border-[#27272e] rounded-xl pl-9 pr-4 py-3 text-sm text-[#f5f5f7] placeholder-[#35353e] font-mono focus:outline-none focus:ring-2 focus:ring-cyan-400/50 focus:border-cyan-400/50 transition-colors"
              />
            </div>
          ...
          {/* Notes */}
          <div>
            <p className="text-xs text-[#71717a] uppercase tracking-wider mb-3">Notes</p>
            <div className="relative">
              <textarea
                value={form.notes}
                ...
                rows={3}
                className="w-full bg-[#1c1c21] border border-[#27272e] rounded-xl px-4 py-3 text-sm text-[#f5f5f7] placeholder-[#35353e] focus:outline-none focus:ring-2 focus:ring-cyan-400/50 focus:border-cyan-400/50 resize-none transition-colors"
              />
          ...
          {/* Actions */}
          <div className="flex gap-3 pt-4 border-t border-[#27272e]">
