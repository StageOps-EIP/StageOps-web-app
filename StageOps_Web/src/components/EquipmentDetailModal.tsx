      ...
      <div className="w-full max-w-2xl bg-[#131316] border border-[#27272e] rounded-2xl shadow-2xl shadow-black/50 max-h-[85vh] overflow-y-auto">
        ...
        <div className="sticky top-0 z-10 bg-[#131316] flex items-center justify-between px-8 py-5 border-b border-[#27272e]">
          <div className="flex items-center gap-3">
            ...
            />
            <div>
              <h2 className="text-lg font-semibold text-[#f5f5f7]">Détail équipement</h2>
              <p className="text-xs text-[#71717a]">{equipment.qrCode}</p>
            </div>
          </div>
          <button
            onClick={onClose}
        ...
        <div className="px-8 py-6 space-y-6">
          ...
          <div className="flex items-start gap-4">
            ...
            <div className="flex-1">
              ...
              <div className="flex items-center gap-2 mt-1">
                ...
                <span className="text-sm text-[#a1a1aa]">{getCategoryLabel(equipment.category)}</span>
              </div>
            </div>
          </div>
          ...
          {/* Statut */}
          <div>
            <p className="text-xs text-[#71717a] uppercase tracking-wider mb-3">Statut</p>
          ...
          {/* Informations */}
          <div>
            <p className="text-xs text-[#71717a] uppercase tracking-wider mb-3">Informations</p>
            <div className="grid grid-cols-2 gap-3">
              ...
              <div className="p-4 bg-[#1c1c21] rounded-xl">
                <div className="flex items-center gap-1.5 mb-2">
                  ...
                  <p className="text-[10px] text-[#71717a] uppercase tracking-wider">Responsable</p>
                </div>
                <input
                  type="text"
              ...
              <div className="p-4 bg-[#1c1c21] rounded-xl">
                <div className="flex items-center gap-1.5 mb-2">
                  ...
                  <p className="text-[10px] text-[#71717a] uppercase tracking-wider">Dernière vérif.</p>
                </div>
          ...
          <div>
            ...
            <div className="flex items-center gap-3 p-4 bg-[#1c1c21] border border-[#27272e] rounded-xl">
